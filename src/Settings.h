...
struct GlobalPrefs {
    ...
    bool smoothScroll;
    // duration (in ms) of smooth scroll interpolation
    int smoothScrollDuration;
    // frame rate (fps) of smooth scroll. 0 means monitor refresh rate
    int smoothScrollFrameRate;
...
static const FieldInfo gGlobalPrefsFields[] = {
    ...
    {offsetof(GlobalPrefs, smoothScrollDuration), SettingType::Int, 200},
    {offsetof(GlobalPrefs, smoothScrollFrameRate), SettingType::Int, 0},
...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "\0ShowLinks\0ShowStartPage\0SidebarDx\0SmoothScroll\0SmoothScrollDuration\0SmoothScrollFrameRate\0TabWidth\0Theme"
    "\0TocDy\0ToolbarSize\0TreeFontName\0TreeFontSize\0UIFontSize\0UseSysColors\0UseTabs\0ZoomLevels\0ZoomIncrement\0\0"
    ...
    "owPos\0FileStates\0SessionData\0ReopenOnce\0TimeOfLastUpdateCheck\0OpenCountWeek\0\0"};
